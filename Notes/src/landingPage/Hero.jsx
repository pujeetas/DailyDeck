    ...
    <div>
      <section className="w-full px-8 pt-20 pb-16 flex flex-col md:flex-row items-center gap-12 relative">
        ...
        <div className="flex-1 flex justify-center md:justify-start">
          <img
            src="https://web-app-images-cdn-store.s3.ap-southeast-2.amazonaws.com/heroIllustration.png"
            alt="Hero-Section-Img"
            className="w-full max-w-md md:max-w-xl object-contain animate-float ml-20"
          />
        </div>
        ...
        <div className="flex-1 text-center md:text-left relative animate-fadeUp">
          ...
          <div className="mt-8 flex justify-center md:justify-start gap-4">
            <button
              ...
              className="cursor-pointer px-6 py-3 bg-slate-900 text-white rounded-lg text-lg hover:bg-black transition"
            >
              Get Started
            </button>
            ...
            <button
              ...
              className="cursor-pointer px-6 py-3 border border-slate-300 text-slate-700 rounded-lg text-lg hover:bg-slate-100 transition"
            >
              Log in
            </button>
          </div>
